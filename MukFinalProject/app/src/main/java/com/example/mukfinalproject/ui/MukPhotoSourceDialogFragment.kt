...
class MukPhotoSourceDialogFragment: DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(context: Context?): MukPhotoSourceDialogFragment? {
            if (context != null && (canPick(context) || canCapture(context))) {
                return MukPhotoSourceDialogFragment()
            }
